...
int altobar=35;
int dano1=10,cura1=10,dano2=25,absorb=7,dano3=1,buff=20,dano4=15,caos=3;//Daño y cura enemigos
float cdatk1=10,cdheal1=25,cdatk2=25,cdabs=5,cdatk3=1,cdbuff=25,cdatk4=15,cdcaos=4;//cd de los enemigos
