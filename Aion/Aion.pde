...
int altobar=35;
int dano1=10,cura1=10,dano2=30,absorb=7,dano3=2,buff=3,dano4=20,caos=9;//Daño y cura enemigos
float cdatk1=10,cdheal1=25,cdatk2=30,cdabs=5,cdatk3=5,cdbuff=7,cdatk4=15,cdcaos=6;//cd de los enemigos
