...
int altobar=35;
int dano1=10,cura1=10,dano2=30,absorb=7,dano3=4,buff=2,dano4=15,caos=3;//Daño y cura enemigos
float cdatk1=10,cdheal1=25,cdatk2=30,cdabs=5,cdatk3=6,cdbuff=7,cdatk4=15,cdcaos=3;//cd de los enemigos
